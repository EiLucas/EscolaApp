...
namespace Escola.UI
{
    public partial class CadastrarTurma_Noite : Form
    {
        public CadastrarTurma_Noite()
        {
            InitializeComponent();
        }
        ...
        {
            TurmaNoiteDTO objCad = new TurmaNoiteDTO();

            objCad.Nome_Aluno = txtAluno.Text;
            objCad.Cod_Aluno = txtCod_Aluno.Text;

            TurmaNoiteBLL objCadastra = new TurmaNoiteBLL();
